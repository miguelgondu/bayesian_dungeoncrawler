...
# from artificial_agents_experiment import last_five_are_equal
...
def baseline_experiment(path, max_iterations, goal, exp_id, verbose=False, model_parameters={}):
    ...
    for i in range(max_iterations - 1):
        ...
        # Breaking if we have 5 repetitions.
        # if last_five_are_equal([it["level"] for it in experiment["iterations"]]):
        #     print(f"Have seen the same level 5 times in a row: {experiment['iterations'][-1]['level']}. Breaking")
        #     break
